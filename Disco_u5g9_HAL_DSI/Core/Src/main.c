...
/* USER CODE BEGIN PV */
LCD_UTILS_Drv_t      LCD_Driver;					//Problem: the actual LCD driver is NOT included from BSP
													//for any of the screens I would use, it would need to be written anew anyway...
...
//static void MX_ICACHE_Init(void);									//REMOVED
...
//Clear LCD
 LCD_FillRect(0, 0, 0, 480, 480, UTIL_LCD_COLOR_BLACK);
...
static void MX_DSIHOST_DSI_Init(void)
{
  ...
  LCD_Set_Default_Clock();											//this is currently just a screen reset
